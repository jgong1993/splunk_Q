...
### [Percentage of rows - Not as precise time frame](https://answers.splunk.com/answers/611632/calculate-percentage-in-every-row-adding-two-searc.html)
<pre>
...
### Transaction per Status - Using more precise time frame
<pre>
